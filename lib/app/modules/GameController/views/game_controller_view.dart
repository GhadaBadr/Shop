...
import 'package:food/app/modules/GameController/views/Gamecontrollerwidget/Slider.dart';
...
class GameControllerView extends GetView<GameControllerController> {
  final String url;
  final String title;
  final String des;
  final String price;
